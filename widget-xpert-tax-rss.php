 ...
 * @since 2.8.0
 */
class Xpert_RSS extends WP_Widget_RSS {

	function Xpert_RSS() {
		$widget_ops = array( 'description' => __('Entries from any RSS or Atom Xpert feed') );
		$control_ops = array( 'width' => 400, 'height' => 200 );
		$this->WP_Widget( 'xpert-rss', __('Xpert RSS'), $widget_ops, $control_ops );
	}
	...
	function widget($args, $instance) {
		...
		if ( ! $term_slug = $this->get_current_term_slug() ) {
			?>
				<p><?php _e( 'I am an invisible Xpert widget.', 'xpert-tax-rss' ); ?></p>
			<?php
			return;
		}
		...
		$url = "http://www.nottingham.ac.uk/xpert/wordpress/seat/$term_slug";
	...
	?>
		<p><?php _e( 'This widget will only display on a taxonomy archive page, whereupon it will display things from the UON Xpert learning objects database.', 'xpert-tax-rss' ); ?></p>
